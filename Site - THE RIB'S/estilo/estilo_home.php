...
#menu-filiais{
    width: 550px;
    height: 250px;
    background-image: url('<?php echo $imgMenu1 ?>');
    clear: both;
    float: left;
    margin-bottom:15px;
    margin-right: 15px;
...
#menu-cadastro{
    ...
    height: 250px;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu2 ?>');
    float: left;
    margin-bottom: 15px;
    margin-right: 15px;
}
...
#menu-contato{
    ...
    height: 250px;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu3 ?>');
    margin-bottom: 15px;
    float: left;
}
...
#menu-cardapio{
    ...
    float: left;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu4 ?>');
    margin-right: 15px;
}
...
#menu-sobre{
    ...
    height: 190px;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu5 ?>');
    float: left;
    margin-right: 15px;
    margin-bottom: 15px;
}
...
#menu-reservas{
    ...
    height: 190px;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu6 ?>');
    float: left;
    margin-bottom: 15px;
}
...
#menu-galeria{
    ...
    height: 190px;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu7 ?>');
    float: left;
    margin-right: 15px;
}
...
#menu-eventos{
    ...
    height: 190px;
    background-size: 100%;
    background-image: url('<?php echo $imgMenu8 ?>');
    float: left;
    margin-right: 15px;
}
