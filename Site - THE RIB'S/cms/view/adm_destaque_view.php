...
?>
    <div id='conteudo_destaque'>
        <div id="content_pratos">
            <p> Escolha um dos pratos para adiciona-lo como destaque: </p>
            <form id="pesquisar" action="?modo=pesquisar" method="post">
                ...
                <p><a href='adm_destaque.php'> Sem filtro </a></p>
            </form>
            <form action="router.php?controller=destaque&modo=<?php echo $modo ?>" method="post" enctype="multipart/form-data">
                ...
                <div id="content_comentario">
                    ...
                    <p>
                        <input type="submit" name="btn_salvar" value="<?php echo $botao ?>" class="botao" />
                        <input type="submit" name="btn_cancelar" value="Cancelar" class="botao" />
                    </p>
                </div>
            </form>
         </div>
