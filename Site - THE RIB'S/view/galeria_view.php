				...
				<div id="galeria">
					<div class="conteudoSuperior">
				        <div class="texto"> Sede </div>
						  <div class="contImg1">
                <img src="<?php echo(substr($imagens_1[0]->url,3));?>">
              </div>
              <div class="contImg2">
                  <img src="<?php echo(substr($imagens_1[1]->url,3));?>">
              </div>
              <div class="contImg2">
                  <img src="<?php echo(substr($imagens_1[2]->url,3));?>">
              </div>
					</div>
					<div class="conteudoSuperior">
          <?php
           ...
           ?>
					<div class="texto"> Filial 1 </div>
					   <div class="contImg1">
                  <img src="fotos/pasta/<?php echo($imagens_2[0]->url);?>">
             </div>
             <div class="contImg02">
                <img src="<?php echo(substr($imagens_2[1]->url,3));?>">
             </div>

             <div class="contImg3">
                  <img src="<?php echo(substr($imagens_2[2]->url,3));?>">
             </div>
             <div class="contImg3">
                  <img src="<?php echo(substr($imagens_2[3]->url,3));?>">
             </div>
					</div>
					<div class="conteudoSuperior">
            <?php
             ...
             ?>
					<div class="texto"> Filial 2 </div>
					   ...
					   <div class="contImg4">
                   <img src="<?php echo(substr($imagens_3[0]->url,3));?>">
             </div>

              <div class="contImg4">
                    <img src="<?php echo(substr($imagens_3[1]->url,3));?>">
              </div>
          ...
          <?php
           ...
           ?>
					<div class="texto"> Filial 3 </div>
					    <div class="contImg1">
                 <img src="<?php echo(substr($imagens_4[0]->url,3));?>">
              </div>

              <div class="contImg2">
                    <img src="<?php echo(substr($imagens_4[1]->url,3));?>">
              </div>
            ...
            <div id="content">
                  ...
                  <?php
                   ...
                   ?>
      								<li>
      									<img src="<?php echo(substr($slider->imagens[$contador]->url, 3));?>"/>
      								</li>
                  <?php
                      $contador ++;
                    }
